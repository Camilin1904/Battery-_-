...
public class Menu {
	...
	public void executeOperation(int operation) {
		...
		case 4:
			System.out.println("El costo promedio de vida util de las baterias recargables es: "+ company.calculateAverageUsefulLifeCost());
		    // "(4) Para Calcular el promedio de costo de vida util de las baterias recargables\n"+ 
			break;
